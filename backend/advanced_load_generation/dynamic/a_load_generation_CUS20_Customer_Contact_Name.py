...
source_file = r"C:\Users\TheresaReinhard\OneDrive - AVAAP\Documents\NKU\CUS_20_New.xlsx"
...
sheet_column_map = {
    "Business Entity Contact": [
        ...
        ("Customer_Contact_ID", "Business Entity Contact ID"),
        ("Customer_ID", "Billable Entity Reference ID"),
        ("Customer_ID", "Billable Entity Reference Descriptor"),
    ],
    "Name Data": [
        ("Customer_Contact_ID", "Business Entity Contact Key"),
        ("Customer_Contact_ID", "Name Data Key"),
...
default_columns = {
    "Business Entity Contact": [
        ("Add Only","1", None),
        ("Billable Entity Reference ID type","Customer_Reference_ID", None),
    ],
    "Name Data": [
