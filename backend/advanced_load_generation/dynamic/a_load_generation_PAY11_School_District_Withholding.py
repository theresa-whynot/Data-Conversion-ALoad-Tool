...
source_file = r"C:\Users\TheresaReinhard\OneDrive - AVAAP\Documents\NKU\a_load\PAY11.xlsx"
target_file = r"C:\Users\TheresaReinhard\OneDrive - AVAAP\Documents\NKU\a_load\Worker_School_District_Withholdings__NKU_GOLD.xlsx"
...
default_columns = {
    ...
    "Grid-3": [
        ("Payroll USA State and Local Tax Election Data Key", "1", None),
        ("Payroll Local School District Authority Reference ID type", "Payroll_Local_School_District_Authority_Tax_Code", None), 
    ],
}
