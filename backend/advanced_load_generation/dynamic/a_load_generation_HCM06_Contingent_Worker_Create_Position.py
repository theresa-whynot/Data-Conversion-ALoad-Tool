...
target_file = r"C:\Users\TheresaReinhard\OneDrive - AVAAP\Documents\CATS\Create Positions_CW_CATS.xlsx"
...
sheet_column_map = {
    ...
    "Position Worker Type Reference": [
        ("Position_Reference_ID", "Create Position Key"),
        ("Contingent_Worker_Type_Reference_ID","Position Worker Type Reference Key"),
        ("Contingent_Worker_Type_Reference_ID","ID"),
    ],
}
...
default_columns = {
    "Create Position": [
        ...
        ("Worker Type Reference ID","CW", None),
    ...
    "Position Worker Type Reference": [
        ("ID type","Contingent_Worker_Type_ID", None),
    ],
}
